...
Jiffy2 is designed to allow you to quickly create a scalable and performant web application using Java.  Its inspiration comes after working with other frameworks
